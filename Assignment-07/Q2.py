...
if city:
    ...
    llm_input = f"""
            ...
            Instruction:
                ...
                suggest appropriate clothing and activities for these weather conditions.The day is good to
                travel or not. Also,the place is suitable for outdoor activities or not and and which
                we can visit in this weather.
